    ...
    <div class="p-date-picker" ref="pDatePicker">
        <div :class="[
            ...
            <div
                    ...
                    :style="caption&&{width: `calc(100% - ${captionWidth+40}px)`}"
                    @click="pickerBoxShow"
            >
                <section :class="[
                            'p-date-trigger-text',
                            toggleVal&&'p-date-trigger-text-range',
                            (!toggleVal&&!quickSwitch)&&(caption?'p-date-trigger-text-padding-4':'p-date-trigger-text-padding')
                        ]"
                    >
    ...
    methods: {
        ...
        getCaptionWidth() {
            ...
            setTimeout(() => {
                ...
                if (scrollWidth < 114) this.captionWidth = scrollWidth;
                else this.captionWidth = 114;
            });
        },
        // 显示清除按钮
        pickerClearShow() {
