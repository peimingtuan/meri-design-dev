<template>
    <div class="Avatar">
        <div class="component component-padding">
            <h1 class="components-title">Avatar组件</h1>
            <div class="avatar">
                <h2 class="components-title-h2">默认头像type可选【type logo text】</h2>
                <section class="list">
            ...
            <div class="avatar">
                <h2 class="components-title-h2">自定义内容</h2>
                <section class="list">
                    <Avatar type="image">
            ...
            <div class="avatar">
                <h2 class="components-title-h2">size可选【自定义 large medium small minimum】</h2>
                <section class="list">
            ...
            <div class="avatar">
                <h2 class="components-title-h2">colorType可选值【 blue cyan turquoise green yellow orange red carmine
                    purple】</h2>
                <section class="list">
